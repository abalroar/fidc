"""Materialize the placement-regime breakdown for closed FIDC offerings."""
...
from services.industry_closed_offer_placement_regime import (  # noqa: E402
...
def main(argv: list[str] | None = None) -> None:
    ...
    print(
        "[ok] regime de colocação materializado: "
