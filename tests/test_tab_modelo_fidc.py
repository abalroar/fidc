...
class TabModeloFidcTests(unittest.TestCase):
    ...
    def test_requested_page_defaults_are_encoded(self) -> None:
        ...
        self.assertEqual(0.0, tab_modelo_fidc.DEFAULT_LIMITE_CARTEIRA_REVOLVENTE_MULTIPLO)
        self.assertEqual(0.20, tab_modelo_fidc.DEFAULT_CRESCIMENTO_MAX_CARTEIRA_AA)
        self.assertEqual(18.0, tab_modelo_fidc.DEFAULT_INICIO_RUNOFF_MESES)
        self.assertEqual(12.0, tab_modelo_fidc.DEFAULT_WRITEOFF_ATRASO_MESES)
    ...
    def test_workbook_mechanics_expander_explains_cash_lock_and_sheet_formulas(self) -> None:
        ...
        self.assertIn("PDD / NPL 90-360", markdown)
    ...
    def test_step_by_step_explains_projected_cash_accounting(self) -> None:
        ...
        self.assertIn("R$ 5,71 atrasam", markdown)
