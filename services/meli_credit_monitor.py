...
MELI_PDF_TARGETS: tuple[dict[str, object], ...] = (
    ...
    {
        "metric": "NPL 1-90d / carteira bruta ex-360",
        "column": "npl_1_90_pct",
        "target": 8.4,
        "unit": "%",
        "diagnostic": "NPL 1-90 dividido pela carteira bruta ex-360.",
    },
    {
        "metric": "NPL 91-360d / carteira bruta ex-360",
        "column": "npl_91_360_pct",
        "target": 14.2,
        "unit": "%",
        "diagnostic": "NPL 91-360 dividido pela carteira bruta ex-360.",
    },
    {
        "metric": "NPL 1-360d / carteira bruta ex-360",
        "column": "npl_1_360_pct",
        "target": 22.6,
        "unit": "%",
        "diagnostic": "NPL total de 1 a 360 dias dividido pela carteira bruta ex-360.",
    },
    {
        "metric": "Crescimento m/m carteira bruta ex-360",
    ...
    {
        "metric": "Crescimento YoY carteira bruta ex-360",
...
MELI_MONITOR_METHODOLOGY_ROWS: tuple[dict[str, str], ...] = (
    {
        "Indicador": "Carteira Bruta ex-360",
    ...
    },
    {
        ...
        "Definição": "Atraso inicial como percentual da carteira bruta ex-360.",
        "Numerador": "npl_1_90",
    ...
    },
    {
        ...
        "Definição": "Atraso maduro como percentual da carteira bruta ex-360.",
...
MELI_CHART_AXIS_ROWS: tuple[dict[str, str], ...] = (
    ...
    },
    {
        ...
        "Eixo esquerdo": "NPL 1-90d e NPL 91-360d como % da carteira bruta ex-360",
        "Eixo direito": "Não usado",
        "Observação": "Barras empilhadas para decompor o NPL remanescente após baixa conceitual de vencidos acima de 360 dias.",
    },
    {
        "Gráfico": "Carteira Bruta ex-360 e crescimento",
        "Eixo esquerdo": "Carteira Bruta ex-360 em R$ com escala dinâmica",
        ...
        rows.extend(
            [
                ...
                _comparison_row(
                    ...
                    cnpj,
                    row,
                    metric="NPL ex-360 total / carteira bruta ex-360",
